...
android {
    namespace = "com.example.multibarcode"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.baghd.barcode"
        minSdk = 23
        targetSdk = 34
        versionCode = 3
        versionName = "3.0"
    ...
    signingConfigs {
        // Fixed debug keystore so the CI-built APK always has the same SHA-1,
        // which Google Sign-In requires to be registered in Firebase.
        getByName("debug") {
